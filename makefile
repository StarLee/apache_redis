...
OBJ=./bin/
CC=gcc -g -I ./include/ -I /usr/local/include/ -I /usr/local/include/log4c/ -L /usr/local/lib/  -llog4c -lhiredis
...
#$(OBJ)test_log:$(OBJ)logs.o $(OBJ)test_log.o $(OBJ)redis_about.o
#	$(CC) -o $@ $(OBJ)logs.o $(OBJ)test_log.o $(OBJ)redis_about.o
...
clean:
	rm ./bin/*.o
install_fix:
	/usr/local/apache2/bin/apxs -I ./include -c -L/usr/local/lib -lhiredis -i -Wc,-O0 ./src/mod_redis.c
